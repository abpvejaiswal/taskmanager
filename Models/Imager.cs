...
namespace GoldiCRM.Models
{
    public class Imager
    {
        ...
        public static void PerformImageResizeAndPutOnCanvas(string pFilePath, string pdestPath, int pWidth, int pHeight)
        {
            ...
            //Save JPEG
            Imager.SaveJpeg(pdestPath, _img2);
